...
$machinestates = array(
    ...
    27 => array(
        ...
        "description" => clienttranslate('${actplayer} can pick a keeper to keep the ${species_name.args.species_name_tr}'),
        "descriptionmyturn" => clienttranslate('${you} can pick a keeper to keep the ${species_name.args.species_name_tr}'),
        "type" => "activeplayer",
    ...
    28 => array(
        ...
        "description" => clienttranslate('${actplayer} can pick a quarantine to put the ${species_name.args.species_name_tr} in'),
        "descriptionmyturn" => clienttranslate('${you} can pick a quarantine to put the ${species_name.args.species_name_tr} in'),
        "type" => "activeplayer",
    ...
    30 => array(
        ...
        "descriptionmyturn" => clienttranslate('${you} must choose to discard or quarantine the ${_private.species_name.args.species_name_tr}'),
        "type" => "activeplayer",
        "args" => "argMngBackup",
    ...
    31 => array(
        ...
        "descriptionmyturn" => clienttranslate('${you} can pick a quarantine to put the ${_private.species_name.args.species_name_tr} in'),
        "type" => "activeplayer",
    ...
    33 => array(
        "name" => "selectZoo",
        "description" => clienttranslate('${actplayer} can pick a zoo to ask help for with the ${species_name.args.species_name_tr}'),
    ...
    35 => array(
        ...
        "description" => clienttranslate('${actplayer} must select a quarantine to put the ${species_name.args.species_name_tr} in'),
        "descriptionmyturn" => clienttranslate('${you} must select a quarantine to put the ${species_name.args.species_name_tr} in'),
        "type" => "activeplayer",
